...
basePrompt = "A professional setting featuring a diverse group of tech experts working collaboratively in a modern office. Emphasize the themes of innovation and agility in technology. Show elements of AI and Blockchain, like holographic displays, digital interfaces, and data analytics. Display a futuristic and dynamic atmosphere, showcasing teamwork and cutting-edge technology in North America. Ensure the setting is sleek and high-tech, with a focus on business transformation and innovation."
basePrompt += " --relax";
